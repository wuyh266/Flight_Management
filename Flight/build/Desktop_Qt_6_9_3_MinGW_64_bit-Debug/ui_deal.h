...
"}"));
        ...
        home->setGeometry(QRect(10, 620, 241, 71));
...
"}"));
        ...
        Deal_2->setGeometry(QRect(250, 620, 241, 71));
...
"}"));
        ...
        Single_Center->setGeometry(QRect(730, 620, 261, 71));
...
"}"));
        ...
        favorite_button->setGeometry(QRect(490, 620, 241, 71));
